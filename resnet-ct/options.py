...
class Options():
    ...
    def __init__(self):
        ...
        ##
        # Base
        self.parser.add_argument('--dataset', default='lung', help='folder | cifar10 | mnist |lung_fanogan')
        ...
        self.parser.add_argument('--isize', type=int, default=64, help='input image size , how many network layers, 64/320/448.')
        self.parser.add_argument('--isize_x', type=int, default=448, help='input image size.')
        self.parser.add_argument('--isize_y', type=int, default=320, help='input image size.')
        ...
        self.parser.add_argument('--model', type=str, help='chooses which model to use. ganomaly')
        self.parser.add_argument('--display_server', type=str, default="http://localhost", help='visdom server of the web display')
        self.parser.add_argument('--display_port', type=int, default=8097, help='visdom port of the web display')
        self.parser.add_argument('--env', type=str, default='cae', help='vidom env name')
        ...
        self.parser.add_argument('--epoch', type=int, default=30, help='Load epoch.')
